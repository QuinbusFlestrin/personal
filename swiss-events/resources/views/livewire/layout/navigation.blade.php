...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('events.submit')" :active="request()->routeIs('events.submit')" wire:navigate>
                        {{ __('Submit an event') }}
                    </x-nav-link>
                    @auth
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="{{ route('login') }}" wire:navigate class="text-sm text-gray-600 hover:text-gray-900">{{ __('Log in') }}</a>
                    <a href="{{ route('register') }}" wire:navigate class="ms-4 text-sm text-gray-600 hover:text-gray-900">{{ __('Register') }}</a>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('events.submit')" :active="request()->routeIs('events.submit')" wire:navigate>
                {{ __('Submit an event') }}
            </x-responsive-nav-link>
            @auth
